> **English:** [Domain-model](Domain-model)
...
Certbot menolak membuat lineage jika `live/{domain}/` sudah ada sebagai placeholder Gosite. Service SSL menjalankan `prepareForCertbot` sebelum enqueue (lihat [sequences/08-website-ssl.md](SSL-and-Certbot-id))).
