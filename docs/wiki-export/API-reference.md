> **Bahasa Indonesia:** [API-reference-id](API-reference-id)

REST API GoSite v1.

Contract: [api/openapi.yaml](https://github.com/jahrulnr/GoSite/blob/master/api/openapi.yaml) · [api/examples/](https://github.com/jahrulnr/GoSite/blob/master/api/examples/)
...
| `gosite nginx-repair` | `nginx -t` + safe auto-fix ([nginx-repair.md](Nginx-auto-repair)) |
...
| Legacy panel | Method | GoSite (implemented) |
|--------|--------|----------------------|
...
Every internal reload calls [nginx auto-repair](Nginx-auto-repair) first.
