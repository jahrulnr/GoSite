...
Lihat diagram historis di git history; alur sama (validasi → DB → `Site::createConfig`) tanpa endpoint validate terpisah dan tanpa `nginx reload` otomatis pada semua path.
